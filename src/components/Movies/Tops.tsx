...
export default function Tops({ title, movies }: any) {
  ...
  /**
   * Aux functions to get the list of genres list by movie or tv show
   * @param id
   * @returns
   */
          ...
          return (
            <div className="tops__movie" key={movie.id}>
              ...
              <div className="tops__movie-info">
                <h4 className="tops__movie__title">
                  {movie.original_title || movie.original_name}
                </h4>
                <p className="tops__movie__gnre">{genreList}</p>
                <p className="tops__movie-year">
                  {movie.release_date || movie.first_air_date}
                </p>
                <div className="top__imdb-container">
                  <img src={imdbLogo} />
